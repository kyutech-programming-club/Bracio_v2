...
public class VRCanvasHUD : MonoBehaviour
{
    ...
    public Button buttonHost, buttonServer, buttonClient, buttonStop, buttonAuto,Pchost;
    ...
    public void Change()
    {
        ...
        ButtonHost();
        Invoke("Prefabchamge",1f);
    }
    public void Prefabchamge()
    {
    ...
    private void Start()
    {
        ...
        Pchost.onClick.AddListener(Change);
